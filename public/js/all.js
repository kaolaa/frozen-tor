...
$(function() {
	...
	//profile popup
	$('.profile-icon, .profile-link').on( "click", function() {
		$(this).siblings('.profile-popup').slideToggle();
		return false;
	});
	$('.profile_close').on( "click", function() {
		$(this).parent('.profile-popup').slideToggle();
		return false;
	});	
	$('.profile-popup .item-remove').on( "click", function() {
		$(this).parents('.hotel-small').remove();
		return false;
	});	
